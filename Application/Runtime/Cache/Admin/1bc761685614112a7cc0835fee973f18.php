...
<body>
    ...
    <div class="alert alert-danger" role="alert" style="font-size:16px">我的信息</div>
...
<table class="tablelist">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even">
            ...
            <?php if(is_array($agency_id)): $i = 0; $__LIST__ = $agency_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><td ><?php echo ($so["agency_id"]); ?></td>
            <td>
                <?php if($so["agency_id"] == 1): echo $vo['price'] * $info['commission_one']/10 ;?>
                <?php elseif($so["agency_id"] == 2): echo $vo['price'] * $info['commission_two']/10 ;?>
                <?php elseif($so["agency_id"] == 3): echo $vo['price'] * $info['commission_three']/10 ;?>
                <?php else: ?> <?php echo $vo['price'] * $info['commission_four']/10 ; endif; ?>
