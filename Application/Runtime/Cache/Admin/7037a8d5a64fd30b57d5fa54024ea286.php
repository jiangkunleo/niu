        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($AuthList)): $i = 0; $__LIST__ = $AuthList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo (str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$vo["level"]*2)); echo ($vo["auth_name"]); ?></td>
                    <td><?php echo ($vo["auth_controller"]); ?></td>
                    <td><?php echo ($vo["auth_action"]); ?></td>
                    <td>
                        <a href="<?php echo U('Auth/edit',array('auth_id'=>$vo['id']));?>" class="tablelink">编辑</a>
                        <a href="<?php echo U('Auth/del',array('auth_id'=>$vo['id']));?>" class="tablelink"> 删除</a>
                    </td>
