...
<body>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo U('Order/reference',array(ids=1));?>" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
               <!--  <li>
                    <label>游戏账号</label>
                ...
                <li>
                    <!-- <label>提现账号</label> -->
                    <input name="id" placeholder="请输入提现帐号" id="status" type="hidden" class="dfinput" />
                </li>
                <li>
                    <label>提现账号</label>
                ...
                <li>
                    <label>提款金额</label>
                    <input name="account_sum" placeholder="请输入提款金额" type="text" class="dfinput"  /><i>*必须为100或100的倍数*</i>
                </li>
                <li class="current">
                    <label>用户名</label>
                    <input name="alipay_name" placeholder="请输入支付宝账户用户名" type="text" class="dfinput"  /><i>*支付宝提现必填*</i>
                </li>
                 <li  class="current">
                    <label>银行卡类别</label>
                    <input name="information" placeholder="请输入银行卡类别" type="text" class="dfinput"  /><i>*银行卡提现提现必填*</i>
                </li>
