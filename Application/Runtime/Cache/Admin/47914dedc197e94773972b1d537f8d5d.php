        ...
        <form action="<?php echo U('Agency/add');?>" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
               <!--  <li>
                ...
                <li>
                    <label>手机号</label>
                    <input name="mobile" placeholder="请输入手机号" id="status" type="datetime" class="dfinput" />
                </li>
                <li>
                ...
                <li>
                    <label>微信号</label>
                    <input name="wechat" placeholder="请输入微信号" type="text" class="dfinput"  /><i>*可选*</i>
                </li>
                <li>
                ...
                <li>
                    <label>地址</label>
                    <input name="address" placeholder="请输入地址" type="text" class="dfinput"  /><i>*可选*</i>
                </li>
                <li>
                ...
                <li>
                    <label>真实姓名</label>
                    <input name="real_name" placeholder="请输入真实姓名" type="text" class="dfinput" />
                </li>
                 <li>
                    <label>游戏昵称</label>
                    <input name="username" placeholder="请输入游戏账号" type="text" class="dfinput" /><i>*登陆的用户名*</i>
                    </li>
                    <li>
                    <input name="salt" placeholder="请输入加密盐值" type="hidden" class="dfinput" /></li>
                 <li>
                <label>登陆密码</label>
                <input name="password" placeholder="请输入登陆密码" type="text" class="dfinput" /></li>
